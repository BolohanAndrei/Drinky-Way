...
<!--
Tip: Add your images and GIFs under /media and update the paths below.
-->

<p align="center">
  <img src="src/res/icon/icon.png" alt="Drinky Way Banner" width="100%">
</p>

<p align="center">
  <a href="https://github.com/BolohanAndrei/Drinky-Way/stargazers"><img alt="GitHub stars" src="https://img.shields.io/github/stars/BolohanAndrei/Drinky-Way?style=social"></a>
  <a href="https://github.com/BolohanAndrei/Drinky-Way/releases"><img alt="Release" src="https://img.shields.io/github/v/release/BolohanAndrei/Drinky-Way?include_prereleases"></a>
  <a href="https://github.com/BolohanAndrei/Drinky-Way"><img alt="Last commit" src="https://img.shields.io/github/last-commit/BolohanAndrei/Drinky-Way/main"></a>
  <a href="https://github.com/BolohanAndrei/Drinky-Way/issues"><img alt="Issues" src="https://img.shields.io/github/issues/BolohanAndrei/Drinky-Way"></a>
  <img alt="Java" src="https://img.shields.io/badge/Java-17%2B-orange?logo=java&logoColor=white">
  <a href="LICENSE"><img alt="License" src="https://img.shields.io/github/license/BolohanAndrei/Drinky-Way?label=license"></a>
</p>
...
- Mini-Games: Dice, darts, arm-wrestling, lockpicking, and more to win coin and clues. (In progress)
...
- Compile & Run (generic Java layout):
  - Linux/macOS:
    ...
    # Replace the main class below with your actual entry point:
    java -cp out your.main.package.Main
    ```
  - Windows (PowerShell):
    ```powershell
    mkdir out
    ...
    java -cp out your.main.package.Main
    ```
- Using Gradle/Maven? Add your commands here (e.g., ./gradlew run or mvn javafx:run).
...
- Tools/Engine: Add details here (Java2D/LWJGL/JavaFX/custom)
...
- Is there a story or is it sandbox?
  - Story-driven with optional side content and mini-games.
...
## License
Choose a license (MIT, GPL-3.0, Apache-2.0, etc.) and add it as `LICENSE` at the root. Read more at [choosealicense.com](https://choosealicense.com/).
